...
You can also find the differences between v1 and v2 in the [Upgrade Guide](http://docs.chainer.org/en/stable/upgrade.rst).
...
The important changes that may affect user code are summarized in the [Upgrade Guide](http://docs.chainer.org/en/stable/upgrade.rst).
...
The detailed explanation can be found in [Contribution Guide](http://docs.chainer.org/en/stable/contribution.rst).
